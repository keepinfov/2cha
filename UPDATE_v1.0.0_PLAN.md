...
> **Статус (2026-06): реализовано в v1.0.0 (протокол v4)**
>
> - Фаза 1 (крипто: X25519, Noise_IK, per-client ключи) — ✅ реализовано
>   (`twocha-core/src/crypto/`; ключи — raw 32 байта + права 0600, без
>   бинарного контейнера из §1.2)
> - Фаза 2 (Noise_IK handshake, MAC1/cookie анти-DoS, новый формат data) —
>   ✅ реализовано (`twocha-core/src/v4/`, `twocha-protocol/src/wire.rs`);
>   обратная совместимость с v3 (§1.3) сознательно **отброшена** — чистый v4
> - Фаза 4.2 (roaming) — ✅ реализовано (сессии по CID, не по адресу)
> - Фаза 5.1 (whitelist) — ✅ реализовано (`[[peers]]` в server.toml)
> - Сверх плана: QUIC-мимикрия wire-формата
> - Фазы 3 (оптимизация), 4.3, 5.2–5.3, 6+ (мобильные) — не реализованы
>
> Актуальное описание протокола: [docs/protocol-v4.md](docs/protocol-v4.md)
