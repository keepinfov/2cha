...
pub use config::{
    ...
    upsert_peer_in_file, AwgSection, CipherSuite, ClientConfig, ConfigError, CryptoSection,
    DnsSection, GatewaySection, Ipv4ClientSection, Ipv4ServerSection, Ipv6ClientSection,
    Ipv6ServerSection, LoggingSection, PeerSection, PerformanceSection, ServerConfig,
    TimeoutsSection, TlsSection, TransportKind, TunSection,
};
