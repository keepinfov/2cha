...
pub use client::{example_client_config, ClientConfig, DnsSection, Ipv4ClientSection, Ipv6ClientSection};
pub use common::{
...
pub use server::{example_server_config, GatewaySection, Ipv4ServerSection, Ipv6ServerSection, ServerConfig};
